...
6. Footer
   ...
   🛠️ Come usare
   Clona o scarica i file nella struttura indicata sopra
   Apri index.html in un browser moderno
   Bootstrap e le immagini si caricano da CDN — richiede connessione internet
   Personalizzazione
   ...
   📄 Licenza
   © 2026 Atelier — Studio di architettura.
